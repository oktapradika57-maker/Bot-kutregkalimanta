...
# ==========================================
# 1. KONFIGURASI KREDENSIAL & ID GOOGLE
# ==========================================
# Pastikan file 'creds.json' berada di folder yang sama dengan file script ini
...
def upload_foto_to_drive(file_uploaded, file_name):
    try:
        ...
        # Mengubah izin file agar bisa dilihat oleh semua orang yang memiliki link
...
if submit_button:
    if nama and foto:
        with st.spinner("Sedang memproses dan mengunggah data..."):
            ...
            # 1. Upload foto ke Drive untuk mendapatkan URL-nya
            ...
            if url_foto:
                ...
                try:
                    ...
                    st.success("🎉 Data dan foto berhasil disimpan ke Google Sheets!")
                except Exception as e:
